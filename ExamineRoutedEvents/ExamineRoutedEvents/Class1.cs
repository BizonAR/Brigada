...
namespace nikbarale.ExamineRoutedEvents
{
    public class ExamineRoutedEvents : Application//производный класс от Application
    {
        ...
        protected override void OnStartup(StartupEventArgs args)//перегружаем OnStartup
        {
            ...
            foreach (UIElement el in els){  // для каждого элемента                                
        ...
        void AllPurposeEventHandler(object sender,  RoutedEventArgs args){             //обработчик событий (кто отправил и что)           
        ...
        string TypeWithoutNamespace(object obj)         {// убираем пробелы             
